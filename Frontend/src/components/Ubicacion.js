...
<div><img className="iconno" src="https://images.vexels.com/media/users/3/128066/isolated/preview/5940a70160831672d35888200bbac868-icono-de-puntero-de-ubicaci--n-de-inicio-by-vexels.png" alt="Logo" /></div>
<div className="Ubbi">
...
<div class="form-group">
  ...
  <option>Ciudad</option>
    ...
    <option>Envigado</option>
      ...
      <Link to="/Inicio" ><button type="button" class="btn btn-dark">Continuar</button></Link>
      </div>
</div>
</form>
