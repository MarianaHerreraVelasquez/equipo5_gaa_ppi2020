...
<>
  ...
  <Navbar bg="dark" variant="dark">
    ...
    <div><img className="Logo" src="https://image.flaticon.com/icons/png/512/17/17004.png" alt="Logo" /></div>
      <h1 className="display-4">Inicio de sesion<option>en SmartMenú</option></h1>
      <p className="lead">
    ...
    <div>
<Link to="/Description" ><button href="/Description" type="button" class="btn btn-dark">Iniciar sesion</button>
</Link></div>
    

<Link to="/Description" ><button href="/Description" type="button" class="btn btn-dark">Iniciar con Facebook</button>
</Link>
    
    

<Link to="/Description" ><button href="/Description" type="button" class="btn btn-dark">Iniciar con Google</button>
</Link>
    
<div>
<Link to="/Registro" ><button href="/Registro" type="button" class="btn btn-dark">Registrate y crea una cuenta</button>
</Link></div>
