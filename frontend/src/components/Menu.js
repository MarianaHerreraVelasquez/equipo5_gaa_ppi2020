...
<>
  ...
  <Navbar bg="dark" variant="dark">
    <Navbar.Brand href="/Description"><img className="Logo" src="../img/Yeah2.jpg" alt=""/><img className="Logo" src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/4b/McDonald%27s_logo.svg/792px-McDonald%27s_logo.svg.png" alt=""/></Navbar.Brand>
...
<div class="container">
  ...
  <select class="form-control" id="sel1">
    ...
    <option>12</option>
      ...
      <td><img className="Logo" src="https://d25dk4h1q4vl9b.cloudfront.net/media/images/menu-content/CO/sandwiches-de-carne/clubhouse_sello_co.png" alt=""/></td>
      <td>CLUB HOUSE</td>
      <td>$27.000</td>
    </tr>
    </thead>
  ...
  <select class="form-control" id="sel1">
    ...
    <option>12</option>
      ...
      <td><img className="Logo" src="https://d25dk4h1q4vl9b.cloudfront.net/media/images/menu-content/CO/pollo/clubhouse_pollo_crispy_sello_co.png" alt=""/></td>
  ...
  <select class="form-control" id="sel1">
    ...
    <option>12</option>
      ...
      <td><img className="Logo" src="https://d25dk4h1q4vl9b.cloudfront.net/media/images/menu-content/CO/sandwiches/crispy_onion_carne_sello_co.png" alt=""/></td>
  ...
  <select class="form-control" id="sel1">
    ...
    <option>12</option>
      ...
      <td><img className="Logo" src="https://d25dk4h1q4vl9b.cloudfront.net/media/images/menu-content/CO/sandwiches/doble_magnifica_sello_co.png" alt=""/></td>
  ...
  <select class="form-control" id="sel1">
    ...
    <option>12</option>
      ...
      <td><img className="Logo" src="https://d25dk4h1q4vl9b.cloudfront.net/media/images/menu-content/CO/sandwiches-de-carne/mc_bacon_triple_sello_co.png" alt=""/></td>
  ...
  <select class="form-control" id="sel1">
    ...
    <option>12</option>
      ...
      <td><img className="Logo" src="https://d25dk4h1q4vl9b.cloudfront.net/media/images/menu-content/CO/sandwiches-de-carne/doble_cuarto_libra_queso_sello_co.png" alt=""/></td>
  ...
  <select class="form-control" id="sel1">
    ...
    <option>12</option>
      ...
      <td><img className="Logo" src="https://d25dk4h1q4vl9b.cloudfront.net/media/images/menu-content/CO/sandwiches/mc_bacon_sello_co.png" alt=""/></td>
      <td>McBACON</td>
      <td>$18.000</td>
    </tr>
      <tr>
  ...
  <select class="form-control" id="sel1">
    ...
    <option>12</option>
      ...
      <td><img className="Logo" src="https://d25dk4h1q4vl9b.cloudfront.net/media/images/menu-content/CO/sandwiches-de-carne/big_mac_sello_co.png" alt=""/></td>
      <td>BIG MAC™</td>
      <td>$27.000</td>
    </tr>
<tr>
  ...
  <select class="form-control" id="sel1">
    ...
    <option>12</option>
      ...
      <td><img className="Logo" src="https://d25dk4h1q4vl9b.cloudfront.net/media/images/menu-content/CO/sandwiches/triple_hamburguesa_con_queso_sello_co.png" alt=""/></td>
      ...
      <tr>
        <td></td>
        <td></td>
        <td><Link to="/Presentacion" ><button className= "btn btn-dark" type="submit">
        Volver
        </button></Link>
        <Link to="/DatosdeOrden" ><button type="button" class="btn btn-dark">Siguiente</button></Link></td>
        <td></td>
      </tr>
    </tbody>
  </table>
